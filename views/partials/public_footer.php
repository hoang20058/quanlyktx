        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 offset-lg-1">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="<?= Security::e(APP_URL); ?>/" class="nav-link p-0 text-muted">Trang chủ</a></li>
                    <li class="nav-item mb-2"><a href="<?= Security::e(APP_URL); ?>/#rooms" class="nav-link p-0 text-muted">Tra cứu phòng</a></li>
                    <li class="nav-item mb-2"><a href="<?= Security::e(APP_URL); ?>/#notices" class="nav-link p-0 text-muted">Thông báo</a></li>
                    <li class="nav-item mb-2"><a href="<?= Security::e(APP_URL); ?>/register.php" class="nav-link p-0 text-muted">Đăng ký</a></li>
                    <li class="nav-item mb-2"><a href="<?= Security::e(APP_URL); ?>/contact.php" class="nav-link p-0 text-muted">Liên hệ</a></li>
                </ul>
            </div>
